...
controller.hears(['dick', 'peen', 'cock', 'shaft', 'pud', 'wang', 'penis', 'dong', 'pud', 'weiner', 'wiener', 'rod'], ['ambient'], function (bot, message) {
...
controller.hears(['goats'], ['ambient'], function (bot, message) {
	bot.reply(message, '```HEY! YOU JUST SAID BETSY\'S MAGIC WORD\n\n @@@@@@@@   @@@@@@    @@@@@@   @@@@@@@   @@@@@@\n@@@@@@@@@  @@@@@@@@  @@@@@@@@  @@@@@@@  @@@@@@@\n!@@        @@!  @@@  @@!  @@@    @@!    !@@\n!@!        !@!  @!@  !@!  @!@    !@!    !@!\n!@! @!@!@  @!@  !@!  @!@!@!@!    @!!    !!@@!!\n!!! !!@!!  !@!  !!!  !!!@!!!!    !!!     !!@!!!\n:!!   !!:  !!:  !!!  !!:  !!!    !!:         !:!\n:!:   !::  :!:  !:!  :!:  !:!    :!:        !:!\n ::: ::::  ::::: ::  ::   :::     ::    :::: ::\n :: :: :    : :  :    :   : :     :     :: : :\n```')
})
